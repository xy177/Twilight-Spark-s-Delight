...
public final class TSDExtraFoodHud {
    private static final ResourceLocation EXTRA_HUNGER =
            ResourceLocation.fromNamespaceAndPath("twilight_spark_delight", "textures/gui/extra_hunger_icons.png");
    private static final ResourceLocation EXTRA_SATURATION =
            ResourceLocation.fromNamespaceAndPath("twilight_spark_delight", "textures/gui/extra_saturation_icons.png");
    ...
    public static void afterFood(net.neoforged.neoforge.client.event.RenderGuiLayerEvent.Post event) {
    ...
    public static void render(GuiGraphics graphics) {
        ...
        int top = graphics.guiHeight() - minecraft.gui.rightHeight + 10;
