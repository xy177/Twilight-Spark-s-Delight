...
public final class TSDExperiment250PedestalEvents {
    ...
    public static void onLevelTick(LevelTickEvent.Post event) {
        Level level = event.getLevel();
        if (level.isClientSide || !event.hasTime()) {
            return;
        }
    ...
    private static boolean isExcludedBoss(LivingEntity target) {
        ...
        return id != null && (id.equals(net.minecraft.resources.ResourceLocation.withDefaultNamespace("ender_dragon"))
                || id.equals(net.minecraft.resources.ResourceLocation.withDefaultNamespace("wither"))
