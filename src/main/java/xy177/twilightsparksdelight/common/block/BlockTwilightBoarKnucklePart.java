...
public class BlockTwilightBoarKnucklePart extends Block
{
    private static final ThreadLocal<BlockPos> CREATIVE_HARVEST = new ThreadLocal<>();
    private final Block controllerBlock;

    public BlockTwilightBoarKnucklePart(Block controllerBlock)
    {
        super(Material.CAKE);
    ...
    {
        BlockPos controllerPos = TwilightBoarKnuckleStructure.findController(world, pos, this.controllerBlock);
        if (controllerPos == null) {
            return false;
        }
        return this.controllerBlock.onBlockActivated(world, controllerPos, world.getBlockState(controllerPos),
    ...
    public void breakBlock(World world, BlockPos pos, IBlockState state)
    {
        if (!world.isRemote && !TwilightBoarKnuckleStructure.isRemoving()) {
            ...
            TwilightBoarKnuckleStructure.destroyControllerFromPart(world, pos, this.controllerBlock, this,
                creativeHarvest);
        }
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess world, BlockPos pos)
    {
        ...
        EnumFacing facing = controllerState.getValue(BlockTwilightBoarKnuckle.FACING);
        return BlockTwilightBoarKnuckle.getModelCellBoundingBox(facing, true);
    }
