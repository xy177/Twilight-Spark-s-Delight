...
public class BlockTwilightBrackenColony extends BlockBush implements IGrowable
{
    ...
    public BlockTwilightBrackenColony()
    {
    ...
    {
        net.minecraft.block.Block richSoil = ForgeRegistries.BLOCKS.getValue(new ResourceLocation("farmersdelight", "rich_soil"));
        ...
        EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        if (!world.isRemote) {
            spawnAsEntity(world, pos, new ItemStack(TSDItems.BRACKEN));
    ...
    {
        drops.add(new ItemStack(TSDItems.BRACKEN, state.getValue(AGE) + 1));
    }
