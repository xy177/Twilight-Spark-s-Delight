...
public final class TSDBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(net.minecraftforge.registries.ForgeRegistries.BLOCKS, TwilightSparksDelight.MOD_ID);
    public static final RegistryObject<xy177.twilightsparksdelight.common.block.TSDMasonJarBlock> MASON_JAR =
            BLOCKS.register("mason_jar", () -> new xy177.twilightsparksdelight.common.block.TSDMasonJarBlock(
                    BlockBehaviour.Properties.of().strength(0.3F).sound(net.minecraft.world.level.block.SoundType.GLASS)));
    public static final RegistryObject<xy177.twilightsparksdelight.common.block.TSDDryingRackBlock> DRYING_RACK =
            BLOCKS.register("drying_rack", () -> new xy177.twilightsparksdelight.common.block.TSDDryingRackBlock(
                    BlockBehaviour.Properties.of().strength(1.0F).sound(net.minecraft.world.level.block.SoundType.WOOD)));
    static {
        TSDItems.ITEMS.register("drying_rack", () -> new BlockItem(DRYING_RACK.get(), new Item.Properties()));
    }

    public static final RegistryObject<TSDTwilightCheeseFondueBlock> TWILIGHT_CHEESE_FONDUE =
    ...
    public static final RegistryObject<TSDSaltHelmetCrabBlock> SALT_HELMET_CRAB =
    ...
    public static final RegistryObject<Block> LABYRINTH_MUSHROOM_COLONY = registerColony("labyrinth_mushroom_colony",
            MapColor.COLOR_RED, TSDItems.LABYRINTH_MUSHROOM);
    public static final RegistryObject<Block> TWILIGHT_BRACKEN_COLONY = registerColony("twilight_bracken_colony",
            MapColor.COLOR_GREEN, TSDItems.BRACKEN);
    public static final RegistryObject<TSDUnripePickledBrackenJarBlock> UNRIPE_PICKLED_BRACKEN_JAR =
    ...
    public static final RegistryObject<TSDPickledBrackenJarBlock> PICKLED_BRACKEN_JAR =
    ...
    public static final RegistryObject<TSDGloryCrucibleBlock> GLORY_CRUCIBLE =
    ...
    public static final RegistryObject<TSDTwilightBorschtBlock> TWILIGHT_BORSCHT =
    ...
    public static final RegistryObject<Block> LABYRINTH_MUSHROOM_CRATE = register("labyrinth_mushroom_crate", MapColor.WOOD);
    public static final RegistryObject<Block> BRACKEN_CRATE = register("bracken_crate", MapColor.WOOD);
    public static final RegistryObject<TSDStructurePartBlock> NAGA_MIXED_RICE_PART =
    ...
    public static final RegistryObject<TSDNagaMixedRiceBlock> NAGA_MIXED_RICE =
    ...
    public static final RegistryObject<TSDAbyssPieBlock> ABYSS_PIE = BLOCKS.register("abyss_pie", () -> new TSDAbyssPieBlock(
    ...
    public static final RegistryObject<TSDStructurePartBlock> TWILIGHT_BOAR_KNUCKLE_PART =
    ...
    public static final RegistryObject<TSDLargeStageFeastBlock> TWILIGHT_BOAR_KNUCKLE =
    ...
    public static final RegistryObject<TSDGiantStoveBlock> GIANT_STOVE =
    ...
    public static final RegistryObject<TSDGiantKitchenPartBlock> GIANT_STOVE_PART =
            BLOCKS.register("giant_stove_part", () -> new TSDGiantKitchenPartBlock(
                    BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.5F),
                    TSDBlocks::giantStove, TSDGiantKitchenPartBlock.Kind.STOVE));
    public static final RegistryObject<TSDGiantCookingPotBlock> GIANT_COOKING_POT =
            BLOCKS.register("giant_cooking_pot", () -> new TSDGiantCookingPotBlock(
                    BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(1.5F),
                    TSDBlocks::giantCookingPotPart, 2));
    public static final RegistryObject<TSDGiantKitchenPartBlock> GIANT_COOKING_POT_PART =
    ...
    public static final RegistryObject<TSDGiantStoveBlock> GIANTS_STOVE =
            BLOCKS.register("giants_stove", () -> new TSDGiantStoveBlock(
                    BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.5F),
                    TSDBlocks::giantsStovePart, 4));
    public static final RegistryObject<TSDGiantKitchenPartBlock> GIANTS_STOVE_PART =
            BLOCKS.register("giants_stove_part", () -> new TSDGiantKitchenPartBlock(
                    BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.5F),
                    TSDBlocks::giantsStove, TSDGiantKitchenPartBlock.Kind.STOVE));
    public static final RegistryObject<TSDGiantCookingPotBlock> GIANTS_COOKING_POT =
            BLOCKS.register("giants_cooking_pot", () -> new TSDGiantCookingPotBlock(
                    BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(1.5F),
                    TSDBlocks::giantsCookingPotPart, 4));
    public static final RegistryObject<TSDGiantKitchenPartBlock> GIANTS_COOKING_POT_PART =
    ...
    private static RegistryObject<Block> register(String id, MapColor color) {
        RegistryObject<Block> block = BLOCKS.register(id, () -> new Block(BlockBehaviour.Properties.of().mapColor(color)
    ...
    private static RegistryObject<Block> registerFeast(String id, MapColor color, RegistryObject<Item> servingItem,
                                                       int servings, boolean hasLeftovers) {
        RegistryObject<Block> block = BLOCKS.register(id, () -> new TSDFeastBlock(
    ...
    private static RegistryObject<Block> registerColony(String id, MapColor color, RegistryObject<Item> harvestItem) {
        RegistryObject<Block> block = BLOCKS.register(id, () -> new TSDColonyBlock(
    ...
    private static RegistryObject<TSDStageFeastBlock> registerStage(String id, MapColor color, String stateName,
                                                                    int maxStage, RegistryObject<Item> servingItem,
                                                                    boolean requiresBowl, int footprint) {
        RegistryObject<TSDStageFeastBlock> block = BLOCKS.register(id, () -> new TSDStageFeastBlock(
                BlockBehaviour.Properties.of().mapColor(color).strength(1.5F)
    ...
    private static RegistryObject<TSDLargeStageFeastBlock> registerLargeStage(
            String id, MapColor color, String stateName, int maxStage,
            RegistryObject<Item> servingItem, boolean requiresBowl, int width, int depth,
            RegistryObject<TSDStructurePartBlock> part) {
        RegistryObject<TSDLargeStageFeastBlock> block = BLOCKS.register(id, () -> new TSDLargeStageFeastBlock(
                BlockBehaviour.Properties.of().mapColor(color).strength(1.5F),
